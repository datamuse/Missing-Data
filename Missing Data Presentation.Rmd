...
<div class="notes">
Each method makes different assumptions or is optimized for a particular type of data (i.e. ordinal, categorical, continuous, descrete, timeseries, panal etc.). Choose the method that fits your data type and problem best. You will likely need to learn a few different methods to handle various types of data. 
</div>
...
5 separate imputations to yeild good estimates of uncertainty. The literature suggests 20 or more imputataions. 
